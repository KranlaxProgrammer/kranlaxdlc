...
vec4 effect( vec4 colour, Image texture, vec2 texture_coords, vec2 screen_coords ) {
    ...
    final_color.rgb = vec3(gray);
    
    final_color.a += (monochrome.x + monochrome.y + time) * 0.00000001; 
